...
uint8_t Servo_ESP8266::attach(int pin)
{
  return attach(pin, MIN_PULSE_WIDTH, MAX_PULSE_WIDTH);
}

uint8_t Servo_ESP8266::attach(int pin, uint16_t minUs, uint16_t maxUs)
{
  if (!_attached) {
...
void Servo_ESP8266::write(int value)
{
...
void Servo_ESP8266::writeMicroseconds(int value)
{
  _valueUs = value;
  if (_attached) {
...
int Servo_ESP8266::read() // return the value as degrees
{
...
int Servo_ESP8266::readMicroseconds()
{
  return _valueUs;
}

bool Servo_ESP8266::attached()
{
  return _attached;
}
